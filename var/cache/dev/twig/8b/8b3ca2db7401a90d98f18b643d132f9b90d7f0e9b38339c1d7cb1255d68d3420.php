...
class __TwigTemplate_311758db8c42581aa26cfb65b74338a5bc8bc221dfc274df92a14245bd4a42c5 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "utilisateur/profil.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "utilisateur/profil.html.twig"));

        $this->parent = $this->loadTemplate("front.html.twig", "utilisateur/profil.html.twig", 1);
...
<div class=\"container rounded bg-white mt-5 mb-5\">
    ...
    <div class=\"row\">
        <div class=\"col-md-2 border-center\">
            <div class=\"d-flex flex-column align-items-center text-center p-3 py-5\"><img class=\"rounded-circle mt-5\" width=\"150px\" src=\"";
        // line 35
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/avatar-default-icon.png"), "html", null, true);
        ...
        // line 39
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_utilisateur_editprofil", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 39, $this->source); })()), "user", [], "any", false, false, false, 39), "id", [], "any", false, false, false, 39)]), "html", null, true);
        echo "\">
                <div class=\"row mt-1\">
                    <div class=\"col-md-6\"><label class=\"labels\">Nom</label><input type=\"text\" class=\"form-control\" name=\"nom\" placeholder=\"";
        // line 41
        ...
        echo "\" value=\"\"></div>
                    <div class=\"col-md-6\"><label class=\"labels\">Prénom</label><input type=\"text\" class=\"form-control\" name=\"prenom\" value=\"\" placeholder=\"";
        // line 42
        ...
        echo "\"></div>
                ...
                <div class=\"row mt-2\">
                    <div class=\"col-md-12\"><label class=\"labels\">Login</label><input disabled type=\"text\" class=\"form-control\" name=\"login\" placeholder=\"";
        // line 45
        ...
        echo "\" value=\"\"></div>
                    <div class=\"col-md-12\"><label class=\"labels\">Date de naissance</label><input disabled type=\"text\" class=\"form-control\" name=\"dateN\" placeholder=\"";
        // line 46
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 46, $this->source); })()), "user", [], "any", false, false, false, 46), "dateNaissance", [], "any", false, false, false, 46), "m/d/Y"), "html", null, true);
        echo "\"></div>
                    <div class=\"col-md-12\"><label class=\"labels\">Adresse mail</label><input disabled type=\"text\" class=\"form-control\" name=\"email\" placeholder=\"";
        // line 47
        ...
        echo "\" value=\"\"></div>
                ...
                <div class=\"mt-5 text-center\"><button type=\"submit\" class=\"btn btn-primary profile-button\">Enregistrer</button></div>
                </form>
            </div>
        </div>   
    </div>
...
";
    ...
    {
        return array (  265 => 47,  261 => 46,  257 => 45,  251 => 42,  247 => 41,  242 => 39,  231 => 35,  221 => 27,  211 => 26,  193 => 23,  175 => 20,  157 => 17,  139 => 14,  121 => 11,  103 => 8,  85 => 5,  66 => 3,  43 => 1,);
    }
...
<div class=\"container rounded bg-white mt-5 mb-5\">
    ...
    <div class=\"row\">
        <div class=\"col-md-2 border-center\">
            <div class=\"d-flex flex-column align-items-center text-center p-3 py-5\"><img class=\"rounded-circle mt-5\" width=\"150px\" src=\"{{asset('img/avatar-default-icon.png')}}\"><span class=\"font-weight-bold\">{{app.user.prenom}} {{app.user.nom}}</span></div>
        </div>
        <div class=\"col-md-5 border-center\">
            <div class=\"p-3 py-5\">
            <form method=\"post\" path=\"{{path('app_utilisateur_editprofil', {'id':app.user.id})}}\">
                <div class=\"row mt-1\">
                    <div class=\"col-md-6\"><label class=\"labels\">Nom</label><input type=\"text\" class=\"form-control\" name=\"nom\" placeholder=\"{{app.user.nom}}\" value=\"\"></div>
                    <div class=\"col-md-6\"><label class=\"labels\">Prénom</label><input type=\"text\" class=\"form-control\" name=\"prenom\" value=\"\" placeholder=\"{{app.user.prenom}}\"></div>
                </div>
                <div class=\"row mt-2\">
                    <div class=\"col-md-12\"><label class=\"labels\">Login</label><input disabled type=\"text\" class=\"form-control\" name=\"login\" placeholder=\"{{app.user.username}}\" value=\"\"></div>
                    <div class=\"col-md-12\"><label class=\"labels\">Date de naissance</label><input disabled type=\"text\" class=\"form-control\" name=\"dateN\" placeholder=\"{{app.user.dateNaissance|date(\"m/d/Y\")}}\"></div>
                    <div class=\"col-md-12\"><label class=\"labels\">Adresse mail</label><input disabled type=\"text\" class=\"form-control\" name=\"email\" placeholder=\"{{app.user.email}}\" value=\"\"></div>
                </div>
                <div class=\"mt-5 text-center\"><button type=\"submit\" class=\"btn btn-primary profile-button\">Enregistrer</button></div>
                </form>
            </div>
...
{% endblock %}", "utilisateur/profil.html.twig", "C:\\Users\\21694\\Desktop\\quantech\\templates\\utilisateur\\profil.html.twig");
    }
}

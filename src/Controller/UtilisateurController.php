...
class UtilisateurController extends Controller
{
     ...
     */
    public function AllUsers(NormalizerInterface $Normalizer, UtilisateurRepository $userRepo){
        $userRepo = $this->getDoctrine()->getRepository(Utilisateur::class);
        $user = $userRepo->findAll();
        $jsonUsers = $Normalizer->normalize($user,'json',['groups'=>'post:read']);
    ...
    public function AddUserJson(Request $request,NormalizerInterface $Normalizer, UserPasswordEncoderInterface $encoder)
    {
        ...
        $hash = $encoder->encodePassword($utilisateur, $request->get('password'));
        $utilisateur->setPassword($hash);
        //$utilisateur->setDateNaissance($request->get('dateNaissance'));
        $utilisateur->setEmail($request->get('email'));
        $utilisateur->setDateNaissance(new \DateTime('@'.strtotime($request->get('dateNaissance'))));

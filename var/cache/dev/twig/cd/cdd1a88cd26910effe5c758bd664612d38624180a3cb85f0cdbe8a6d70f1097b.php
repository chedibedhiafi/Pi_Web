...
class __TwigTemplate_f1910e8d4115007143f7b2089e5dcbc07d31b0dab749cb7ee53735e4e8c7ecea extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_table($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<div class=\"container-fluid pt-4 px-4\" align=\"center\">
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 14
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Login</th>
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 18, $this->source); })()), "login", [], "any", false, false, false, 18), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Mdp</th>
                <td>";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 22, $this->source); })()), "mdp", [], "any", false, false, false, 22), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>DateNaissance</th>
                <td>";
        // line 26
        ((twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 26, $this->source); })()), "dateNaissance", [], "any", false, false, false, 26)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 26, $this->source); })()), "dateNaissance", [], "any", false, false, false, 26), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
            <tr>
                <th>Nom</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 42, $this->source); })()), "tentative", [], "any", false, false, false, 42), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>UnlockDate</th>
                <td>";
        // line 46
        ((twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 46, $this->source); })()), "unlockDate", [], "any", false, false, false, 46)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 46, $this->source); })()), "unlockDate", [], "any", false, false, false, 46), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  245 => 67,  227 => 65,  209 => 63,  191 => 61,  177 => 56,  172 => 54,  167 => 52,  158 => 46,  151 => 42,  144 => 38,  137 => 34,  130 => 30,  123 => 26,  116 => 22,  109 => 18,  102 => 14,  92 => 6,  82 => 5,  63 => 3,  40 => 1,);
    }
...
{% block table %}
<div class=\"container-fluid pt-4 px-4\" align=\"center\">
\t\t\t<div class=\"bg-light rounded h-100 p-4\" align=\"center\">
    <h1>Utilisateur</h1>
    ...
    <br>
    <a href=\"{{ path('app_utilisateur_index') }}\">Retour</a>
...
{% endblock %}
{% block messages %}
{% endblock %}", "utilisateur/show.html.twig", "C:\\Users\\21694\\Desktop\\quantech\\templates\\utilisateur\\show.html.twig");
    }
}

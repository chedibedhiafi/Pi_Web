...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\EmployeType', 1 => 'App\\Form\\ResetPassType', 2 => 'App\\Form\\UtilisateurType', 3 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 6 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder15668 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd4ff7 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties1c78e = [
        
    ];

    public function getConnection()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getConnection', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getMetadataFactory', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getExpressionBuilder', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'beginTransaction', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getCache', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'transactional', array('func' => $func), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'wrapInTransaction', array('func' => $func), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'commit', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->commit();
    }

    public function rollback()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'rollback', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getClassMetadata', array('className' => $className), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'createQuery', array('dql' => $dql), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'createNamedQuery', array('name' => $name), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'createQueryBuilder', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'flush', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'clear', array('entityName' => $entityName), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->clear($entityName);
    }

    public function close()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'close', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->close();
    }

    public function persist($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'persist', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'remove', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'refresh', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'detach', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'merge', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'contains', array('entity' => $entity), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getEventManager', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getConfiguration', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'isOpen', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getUnitOfWork', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getProxyFactory', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'initializeObject', array('obj' => $obj), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'getFilters', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'isFiltersStateClean', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'hasFilters', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return $this->valueHolder15668->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd4ff7 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder15668) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder15668 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder15668->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__get', ['name' => $name], $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        if (isset(self::$publicProperties1c78e[$name])) {
            return $this->valueHolder15668->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder15668;
    ...
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;
    ...
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__isset', array('name' => $name), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;
    ...
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__unset', array('name' => $name), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;
    ...
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__clone', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        $this->valueHolder15668 = clone $this->valueHolder15668;
    }

    public function __sleep()
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, '__sleep', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        return array('valueHolder15668');
    }
    ...
    {
        $this->initializerd4ff7 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd4ff7;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'initializeProxy', array(), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder15668;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder15668;
    }
}
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerd4ff7 && ($this->initializerd4ff7->__invoke($valueHolder15668, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerd4ff7) || 1) && $this->valueHolder15668 = $valueHolder15668;

        if ($this->valueHolder15668 === $returnValue = $this->valueHolder15668->paginate($target, $page, $limit, $options)) {
            return $this;
        }

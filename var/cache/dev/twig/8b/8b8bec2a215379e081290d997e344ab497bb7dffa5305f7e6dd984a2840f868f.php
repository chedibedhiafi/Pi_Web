...
class __TwigTemplate_7ce42d3170032c3e1f8d9dd0e1e74819761b7f7e1b027ed16e577a378521a8b4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["employes"]) || array_key_exists("employes", $context) ? $context["employes"] : (function () { throw new RuntimeError('Variable "employes" does not exist.', 16, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["employe"]) {
            ...
            echo "            <tr>
                <td>";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["employe"], "role", [], "any", false, false, false, 18), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employe_show", ["id" => twig_get_attribute($this->env, $this->source, $context["employe"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employe_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["employe"], "id", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "employe/index.html.twig", "C:\\Users\\21694\\Desktop\\quantech\\templates\\employe\\index.html.twig");
    }
}

...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.tjbGCGE' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_TjbGCGEService()
    {
        return $this->privates['.service_locator.tjbGCGE'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\UtilisateurController::index' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\UtilisateurController::indexAdmin' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            ...
            'App\\Controller\\UtilisateurController::signup' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\EmployeController:delete' => ['privates', '.service_locator.OXHRG7d', 'get_ServiceLocator_OXHRG7dService', false],
            'App\\Controller\\EmployeController:edit' => ['privates', '.service_locator.OXHRG7d', 'get_ServiceLocator_OXHRG7dService', false],
            'App\\Controller\\EmployeController:index' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            'App\\Controller\\EmployeController:new' => ['privates', '.service_locator.x8FmIZ0', 'get_ServiceLocator_X8FmIZ0Service', false],
            ...
            'App\\Controller\\UtilisateurController::indexAdmin' => '?',
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder1fc2b = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerb969e = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties18488 = [
        
    ];

    public function getConnection()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getConnection', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getMetadataFactory', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getExpressionBuilder', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'beginTransaction', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getCache', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getCache();
    }

    public function transactional($func)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'transactional', array('func' => $func), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'wrapInTransaction', array('func' => $func), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'commit', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->commit();
    }

    public function rollback()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'rollback', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getClassMetadata', array('className' => $className), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'createQuery', array('dql' => $dql), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'createNamedQuery', array('name' => $name), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'createQueryBuilder', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'flush', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'clear', array('entityName' => $entityName), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->clear($entityName);
    }

    public function close()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'close', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->close();
    }

    public function persist($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'persist', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'remove', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'refresh', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'detach', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'merge', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getRepository', array('entityName' => $entityName), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'contains', array('entity' => $entity), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getEventManager', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getConfiguration', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'isOpen', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getUnitOfWork', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getProxyFactory', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'initializeObject', array('obj' => $obj), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'getFilters', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'isFiltersStateClean', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'hasFilters', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return $this->valueHolder1fc2b->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerb969e = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder1fc2b) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder1fc2b = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder1fc2b->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__get', ['name' => $name], $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        if (isset(self::$publicProperties18488[$name])) {
            return $this->valueHolder1fc2b->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder1fc2b;
    ...
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;
    ...
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__isset', array('name' => $name), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;
    ...
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__unset', array('name' => $name), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;
    ...
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__clone', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        $this->valueHolder1fc2b = clone $this->valueHolder1fc2b;
    }

    public function __sleep()
    {
        $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, '__sleep', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;

        return array('valueHolder1fc2b');
    }
    ...
    {
        $this->initializerb969e = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerb969e;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerb969e && ($this->initializerb969e->__invoke($valueHolder1fc2b, $this, 'initializeProxy', array(), $this->initializerb969e) || 1) && $this->valueHolder1fc2b = $valueHolder1fc2b;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder1fc2b;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder1fc2b;
    }
}

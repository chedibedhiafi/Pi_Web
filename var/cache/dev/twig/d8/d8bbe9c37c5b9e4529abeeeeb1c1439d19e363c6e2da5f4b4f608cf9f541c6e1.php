...
class __TwigTemplate_455c7c470af5c4cabd4aa3b8087bd5e93c809c967a20b4588a5e74f02bdb14b2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("front(soulayma).html.twig", "utilisateur/login.html.twig", 1);
    ...
    public function block_contactus($context, array $blocks = [])
    {
        ...
        echo "                        <div class=\"form-floating mb-3\">
                            <input type=\"text\" required name=\"_username\" class=\"form-control\" id=\"floatingInput\" placeholder=\"Login\">
                            <label for=\"username\">Login</label>
                        </div>
                        <div class=\"form-floating mb-4\">
                            <input type=\"password\" required name=\"_password\" class=\"form-control\" id=\"floatingPassword\" placeholder=\"Mot de passe\">
        ...
        echo "\">Mot de passe oublié</a>
                        ...
                        <p class=\"text-center mb-0\">Vous n'êtes pas inscrit? <a href=\"";
        // line 55
...
";
    ...
    {
        return array (  264 => 55,  257 => 51,  242 => 38,  236 => 36,  234 => 35,  230 => 34,  221 => 27,  211 => 26,  193 => 23,  175 => 20,  157 => 17,  139 => 14,  121 => 11,  103 => 8,  85 => 5,  66 => 3,  43 => 1,);
    }
...
<div class=\"container-fluid\">
            ...
            <h2>Connexion</h2>
                        ...
                        <form action =\"{{path('app_utilisateur_login')}}\" method=\"post\">
                        {% if error %}
                            <div class=\"alert alert-danger\">{{ 'Paramètres invalides' }}</div>
                        {% endif %}
                        ...
                        <p class=\"text-center mb-0\">Vous n'êtes pas inscrit? <a href=\"{{path('app_utilisateur_signup')}}\">Créer un compte</a></p>
                    </div>
                </div>
            </div>
        </div>
...
{% endblock %}", "utilisateur/login.html.twig", "C:\\Users\\21694\\Desktop\\quantech\\templates\\utilisateur\\login.html.twig");
    }
}
